		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo CI/CD",
									"targetURL": "#fioridemocicd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioridemocicd-display": {
								"semanticObject": "fioridemocicd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioridemocicd",
									"url": sap.ui.require.toUrl("fioridemocicd")
								}
							}
						}
					}
